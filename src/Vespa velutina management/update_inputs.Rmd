...
```{r export nesten}
if(file.exists("./data/output/UAT_processing/nesten.geojson")){
  file.remove("./data/output/UAT_processing/nesten.geojson")
}

st_write(data_nest_final %>% filter(year >= 2017),
         "./data/output/UAT_processing/nesten.geojson",
         append = FALSE)
