...
```{r get_data_baseline}
df_bl <- read_csv(
  file = "https://zenodo.org/records/10058400/files/be_classes_cube.csv?download=1",
  col_types = cols(
    year = col_double(),
    eea_cell_code = col_character(),
    classKey = col_double(),
...
aws.s3::s3save(df_ts, object = "df_timeseries.Rdata", bucket = Sys.getenv("UAT_bucket"), 
