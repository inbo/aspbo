...
gemeentes <- geojson_sf("./spatial/input/communes.geojson")
gemeentes <- st_transform(gemeentes, 4326)
provincies <- geojson_sf("./spatial/input/provinces.geojson")
...
```{r export cleanData}
write_csv(cleanData, "./data/interim/Lithobates_catesbeianus_management_data.csv")
```
