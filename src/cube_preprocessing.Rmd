...
utm1_gemeentes_provincies<-sf::st_read("./data/output/UAT_processing/grid/utm1_bel_with_regions.gpkg", layer="utm1_bel_with_regions" )
```
...
dplyr::left_join(df, utm1_gemeentes_provincies, by = join_by(eea_cell_code == CELLCODE))
```
