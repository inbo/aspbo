...
asp_cmd <- paste0("docker run -it -v C:/Users/", Sys.getenv("USERNAME"), "/.aws :/root/.aws -p 3000:3838 inbo/alienspecies R -e 'alienSpecies::setupS3(inboUser = '",Sys.getenv("USERNAME"), "');alienSpecies::runShiny'")
