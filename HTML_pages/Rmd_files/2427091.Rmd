...
#### **Achtergrond** <br>
De Amerikaanse stierkikker (*Lithobates catesbeianus*) is één van de grootste kikkers ter wereld, en is zeer competitief en vraatzuchtig. De soort kan drager zijn van verschillende ziektes en vormt een bedreiging voor inheemse amfibieënsoorten en de algemene biodiversiteit. In Vlaanderen zijn er momenteel een aantal populaties van de Amerikaanse stierkikker, waarvan de grootste zich in de vallei van de Grote Nete bevindt.
<br>
<br>
...
#### **Background** <br>
The American bullfrog (*Lithobates catesbeianus*) is one of the largest frogs in the world and is known to be very competitive and voracious. The species can carry various diseases and poses a threat to native amphibian species as well as biodiversity in general. Currently, there are several populations of the American bullfrog in Flandres, the largest of which can be found in the Grote Nete valley.
<br>
<br>

#### **Useful links** <br>
Sightings of the American bullfrog can be reported on the website www.waarnemingen.be. Your reports are valuable for monitoring and researching the species.<br>
**Report a sighting: <a href=\"", link1, "\">www.waarnemingen.be</a>**<br>
<br>
...
#### **Contexte** <br>
La grenouille taureau (*Lithobates catesbeianus*) est l'une des plus grandes grenouilles du monde, et elle est très compétitive et vorace. Cette espèce peut être porteuse de diverses maladies et constitue une menace pour les espèces indigènes d'amphibiens ainsi que pour la biodiversité en général. En Flandre, il existe actuellement plusieurs populations de grenouilles taureau, dont la plus grande se trouve dans la vallée de la Grande Nèthe.
<br>
<br>

#### **Liens utiles** <br>
Pour signaler des observations de la grenouille taureau, vous pouvez vous rendre sur www.waarnemingen.be. Vos signalements sont utiles pour la surveillance et la recherche sur cette espèce.<br>
**Signalez une observation: <a href=\"", link1, "\">www.waarnemingen.be</a>**<br>
<br>
